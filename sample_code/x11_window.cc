/*
 *  This source code is copied from Internet.
 *  It is just for study purpose and be caution to use it.
 *
 *  Build instruction:
 *  g++ x11_window.cc -I/usr/X11R6/include -I/usr/X11R6/include/X11 -L/usr/X11R6/lib -L/usr/X11R6/lib/X11 -lX11
 */
#include <X11/Xlib.h>
#include <X11/Xutil.h>
#include <X11/Xos.h>
...
int main(int argc, char** argv)
{
...
#if 0 // Make the window in fullscreen mode.
  ...
  xclient.xclient.window = win;
  xclient.xclient.message_type = WM_STATE;
  xclient.xclient.format = 32;
  xclient.xclient.data.l[0] = 1;
  xclient.xclient.data.l[1] = FULLSCREEN;
  xclient.xclient.data.l[2] = None;
  xclient.xclient.data.l[3] = 1;
  xclient.xclient.data.l[4] = 0;

  XSendEvent(dpy, RootWindow(dpy, s), False,
